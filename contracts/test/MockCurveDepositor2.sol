...
contract MockCurveDepositor2 is ICurveDepositor2, MockCurveDepositor {
  ...
  function add_liquidity(uint256[2] memory _amounts, uint256) external override {
  ...
  function calc_token_amount(uint256[2] memory _amounts, bool) external view override returns (uint256) {
    require(_amounts[index] != 0, "NULL_ADD_LIQUIDITY_AMOUNT");
